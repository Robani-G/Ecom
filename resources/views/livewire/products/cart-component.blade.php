                                ...
                                @foreach (Cart::content() as $item)
                                    ...
                                    <td class="text-center" data-title="Stock">
                                        <div class="detail-qty border radius  m-auto">
                                            <a href="#" wire:click="increaseqty('{{$item->rowId}}')" class="qty-down">+</a>
                                            <span class="qty-val"> {{$item ->qty}} </span>
                                            {{-- <input type="number" name="quantity" id=""> --}}
                                            <a href="#" wire:click="decreaseqty('{{$item->rowId}}')" class="qty-up">-</i></a>
                                        </div>
                                    </td>
                                    <td class="text-right" data-title="Cart">
                                        <span>${{$item ->subtotal}} </span>
                                    </td>
                                    <td class="action" data-title="Remove"><button wire:click="delete('{{$item->rowId}}')" class="text-muted"> x </button></td>
                                </tr>
                                @endforeach
